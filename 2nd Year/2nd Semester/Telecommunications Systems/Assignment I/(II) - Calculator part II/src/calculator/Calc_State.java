...
public class Calc_State {
    ...
    public boolean execute_or_push_operation(long new_operand, char new_operation) {
        ...
        switch (first_pair.operation) {
            ...
            case '+':   // Calculate pending addition
                if(new_operation == '*'){
                  second_pair.operand = first_pair.operand;
                  second_pair.operation = first_pair.operation;
                }
                else{
                    if(new_operation == '='){
                        first_pair.operand += new_operand;
            ...
            case '*':
                ...
                break;
            case '=':
                if(second_pair.operation == '*'){
                    first_pair.operand *= second_pair.operand; 
                }
                break;
    ...
    private final Pair second_pair;  
