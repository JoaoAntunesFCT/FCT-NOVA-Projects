...
struct _sequencia{
	void * * elems; // apontador para vector de enderecos de elementos - o primeiro asterisco mostra que a variável do tipo (void *), o segundo apenas indica que um vetor do tipo void *
	int numElems;
...
//Função auxiliar no caso de os elementos excederem a capacidade predefinida
